...
<a
href="https://github.com/AnswerDotAI/fastcdp/blob/main/fastcdp/ext.py#L164"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/fastcdp/blob/main/fastcdp/ext.py#L159"
target="_blank" style="float:right; font-size:smaller">source</a>

### ExtCDP.pages

``` python
async def pages()->ExtTargets: # Rows with `tabId`, `id`, `title`, `url`, ...; `*` marks debugger-attached
```
...
<a
href="https://github.com/AnswerDotAI/fastcdp/blob/main/fastcdp/ext.py#L153"
target="_blank" style="float:right; font-size:smaller">source</a>
